...
var Option = function Option(props) {
  var id = props.id,
      ...
      enableOnlyText = props.enableOnlyText;
  ...
  }), body, enableOnly && React__default.createElement("button", {
...
function (_React$PureComponent) {
  ...
  function Picky(props) {
    ...
    _this.toggleDropDown = _this.toggleDropDown.bind(_assertThisInitialized$1(_assertThisInitialized$1(_this)));
    _this.toggleSelectAll = _this.toggleSelectAll.bind(_assertThisInitialized$1(_assertThisInitialized$1(_this)));
    _this.onFilterChange = _this.onFilterChange.bind(_assertThisInitialized$1(_assertThisInitialized$1(_this)));
    _this.selectValue = _this.selectValue.bind(_assertThisInitialized$1(_assertThisInitialized$1(_this)));
    _this.selectOnly = _this.selectOnly.bind(_assertThisInitialized$1(_assertThisInitialized$1(_this)));
    _this.allSelected = _this.allSelected.bind(_assertThisInitialized$1(_assertThisInitialized$1(_this)));
    _this.handleOutsideClick = _this.handleOutsideClick.bind(_assertThisInitialized$1(_assertThisInitialized$1(_this)));
    _this.isItemSelected = _this.isItemSelected.bind(_assertThisInitialized$1(_assertThisInitialized$1(_this)));
    _this.focusFilterInput = _this.focusFilterInput.bind(_assertThisInitialized$1(_assertThisInitialized$1(_this)));
    _this.getValue = _this.getValue.bind(_assertThisInitialized$1(_assertThisInitialized$1(_this)));
    return _this;
  }
  ...
  _createClass$1(Picky, [{
    ...
    value: function allSelected(overrideSelected) {
      ...
      var copiedOptions = options.map(this.getValue);
      ...
      return items.map(function (item, index) {
        ...
        if (typeof render === 'function') {
          ...
          return React__default.createElement("div", {
            ...
            selectOnly: _this4.selectOnly,
            enableOnly: _this4.props.enableOnly,
            enableOnlyText: _this4.props.enableOnlyText
          })));
        }
      });
    }
    ...
    value: function render() {
      ...
      var _this$props3 = this.props,
          ...
          includeSelectAll = _this$props3.includeSelectAll,
          includeFilter = _this$props3.includeFilter,
          filterDebounce = _this$props3.filterDebounce,
